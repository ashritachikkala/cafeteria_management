...
class CartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post cart_items_url, params: { cart_item: { menu_item_id: @cart_item.menu_item_id, menu_item_name: @cart_item.menu_item_name, menu_item_price: @cart_item.menu_item_price } }
    end
  ...
  test "should update cart_item" do
    patch cart_item_url(@cart_item), params: { cart_item: { menu_item_id: @cart_item.menu_item_id, menu_item_name: @cart_item.menu_item_name, menu_item_price: @cart_item.menu_item_price } }
